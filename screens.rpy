...
screen quick_menu():
    ...
    if quick_menu:
        ...
        add "gui/quick_menu/quick_menu_bg.png" at quick_button_base_fade
        ...
        hbox:
            ...
            imagebutton:
                idle "gui/quick_menu/save.png"
                selected_hover "gui/quick_menu/save.png"
                action ShowMenu('save')
            imagebutton:
                idle "gui/quick_menu/load.png"
                selected_hover "gui/quick_menu/load.png"
                action ShowMenu('load')
            imagebutton:
                idle "gui/quick_menu/config.png"
                selected_hover "gui/quick_menu/config.png"
                action ShowMenu('preferences')
            imagebutton:
                idle "gui/quick_menu/hide.png"
                selected_hover "gui/quick_menu/hide.png"
                action Call("_hide_windows")
            imagebutton:
                idle "gui/quick_menu/auto.png"
                selected_hover "gui/quick_menu/auto.png"
                action Preference("auto-forward", "toggle")
            imagebutton:
                idle "gui/quick_menu/history.png"
                selected_hover "gui/quick_menu/history.png"
                action ShowMenu('history')
            imagebutton:
                idle "gui/quick_menu/home.png"
                selected_hover "gui/quick_menu/home.png"
                action MainMenu()
            imagebutton:
                idle "gui/quick_menu/exit.png"
                selected_hover "gui/quick_menu/exit.png"
