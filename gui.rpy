...
## 游戏内文本使用的字体。
define gui.text_font = "SourceHanSerifCN-SemiBold.otf" 

##游戏内文本使用的颜色
define gui.text_color = "#1a1a1a"

## 角色名称使用的字体。
define gui.name_text_font = "SourceBirdsong.ttf"

## 游戏外文本使用的字体。
define gui.interface_text_font = "SourceHanSerifCN-SemiBold.otf"
...
define gui.nvl_text_ypos = 170
define gui.nvl_text_width = 1480
